...
<div class="login">
	...
	<form method="post" action="../controller/validar.php">
    	<input type="text" name="username" placeholder="Nombre de usuario" required="required" autocomplete="off">
        <input type="password" name="password" placeholder="Contraseña" required="required" autocomplete="off">
        <button type="submit" class="btn btn-primary btn-block btn-large" name="submit">Entrar ahora</button>
    </form>
</div>
